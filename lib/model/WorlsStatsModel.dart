import 'dart:convert';
/// updated : 1688888448229
/// cases : 691227925
/// todayCases : 5
/// deaths : 6898445
/// todayDeaths : 0
/// recovered : 663827858
/// todayRecovered : 23249
/// active : 20501622
/// critical : 37270
/// casesPerOneMillion : 88678
/// deathsPerOneMillion : 885
/// tests : 6997299296
/// testsPerOneMillion : 880724.53
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2580.46
/// recoveredPerOneMillion : 83553.59
/// criticalPerOneMillion : 4.69
/// affectedCountries : 231

WorlsStatsModel worlsStatsModelFromJson(String str) => WorlsStatsModel.fromJson(json.decode(str));
String worlsStatsModelToJson(WorlsStatsModel data) => json.encode(data.toJson());
...
WorlsStatsModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorlsStatsModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
